...
func documentedFlags() map[string][]string {
	return map[string][]string{
		...
		"list":            {"names"},
		"branch create":   {"no-inject", "ticket"},
		"branch clone":    {"no-inject", "ticket"},
		"branch list":     {"state", "json", "detailed"},
		"branch set-state":  {"clear"},
		"branch set-ticket": {"clear"},
		"branch set-description": {"clear"},
		"branch submit":   {"fill", "draft", "reviewer", "base", "title", "body"},
		"branch attach":   {"current"},
		"branch checks":   {"watch"},
		"branch review":   {"approve", "comment"},
		"branch merge":    {"squash", "rebase", "delete-branch"},
